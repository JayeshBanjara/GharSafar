...
import 'broker_home_controller.dart';
...
class _BrokerHomePageState extends State<BrokerHomePage> {
  final brokerHomeController = Get.put(BrokerHomeController());

  @override
  void dispose() {
    Get.delete<BrokerHomeController>();
    super.dispose();
  }
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        brokerHomeController.isFavouriteSelected[index] = !brokerHomeController.isFavouriteSelected[index];
                        brokerHomeController.update();
                      },
                      child: SvgPicture.asset(brokerHomeController.isFavouriteSelected[index]
