...
import 'broker_edit_profile/broker_edit_profile.dart';
import 'broker_profile_controller.dart';
import 'broker_sell_rent_property/broker_sell_rent_property.dart';
...
class _BrokerProfilePageState extends State<BrokerProfilePage> {
  final brokerProfileController = Get.put(BrokerProfileController());

  bool status = false;

  @override
  void dispose() {
    Get.delete<BrokerProfileController>();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
        init: BrokerProfileController(),
        builder: (cont) {
          brokerProfileController.context = context;
          return Container(
              color: Colors.white,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                              onTap:(){
                                Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => const BrokerEditProfilePage()),);
                              } ,
                          ...
                          InkWell(
                              onTap:(){
                                Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => const BrokerSellRentPropertyPage()),);
                              } ,
  ...
  void logOutDialogue() async {
    await showDialog(
      context: brokerProfileController.context,
